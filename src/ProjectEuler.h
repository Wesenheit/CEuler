...
namespace NumberTheory
{
    ...
    template <typename T,typename S> vector<T> primes(S u,T* tab);// return array of primes dividing s, tab =sito
    template <typename T,typename S> T tot(S x, T* tab);//return totient of x, tab=sito
